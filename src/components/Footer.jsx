              ...
              <div className="flex flex-wrap items-center gap-3 md:flex-nowrap">
                ...
                <div className="flex flex-wrap items-center gap-4 md:flex-nowrap">
                  <div className="inline-flex items-center whitespace-nowrap gap-2">
                    <a href="tel:+919677210456" className="hover:text-accent transition-colors" aria-label="Call +91 96772 10456">+91 96772 10456</a>
                    <a
                  ...
                  <div className="inline-flex items-center whitespace-nowrap gap-2">
                    <a href="tel:+919080730058" className="hover:text-accent transition-colors" aria-label="Call 90807 30058">90807 30058</a>
                    <a
